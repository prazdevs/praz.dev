...
::code-block{title="src/store/index.js"}
```javascript
...
::code-block{title="title=src/store/rootReducer.js"}
```javascript
...
::code-block{title="src/store/auth/authActionTypes.js"}
```javascript
...
::code-block{title="src/store/auth/authActions.js"}
```javascript
...
::code-block{title="src/store/auth/authReducer.js"}
```javascript
import types from './authActionTypes';
...
::code-block{title="src/store/rootSaga.js"}
```javascript
...
::code-block{title="src/store/auth/authSagas/js"}
```javascript
...
::code-block{title="src/components/LogIn.js"}
```javascript
...
::code-block{title="src/components/Register.js"}
```javascript
import React, { useState } from 'react';
import { useDispatch } from 'react-redux';
