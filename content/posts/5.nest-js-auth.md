...
::code-block{title="src/app.module.ts"}
```typescript
...
::code-block{title="src/auth/auth/module.ts"}
```typescript
import { Module } from '@nestjs/common';
import { ConfigModule } from '@nestjs/config';
import { MongooseModule } from '@nestjs/mongoose';
...
::code-block{title="src/auth/schemas/user.schema.ts"}
```typescript
...
::code-block{title="src/auth/dto/auth-credentials.dto.ts"}
```typescript
...
::code-block{title="src/auth/interfaces/user.interface.ts"}
```typescript
...
::code-block{title="src/auth/auth.service.ts"}
```typescript
...
::code-block{title="src/auth/auth.controller.ts"}
```typescript
...
::code-block{title="src/auth/strategies/local.strategy.ts"}
```typescript
...
::code-block{title="src/auth/guards/local-auth.guard.ts"}
```typescript
...
::code-block{title="src/auth/strategies/jwt-auth.strategy.ts"}
```typescript
import { Injectable } from '@nestjs/common';
import { PassportStrategy } from '@nestjs/passport';
...
::code-block{title="src/auth/guards/jwt-auth.guard.ts"}
```typescript
import { Injectable } from '@nestjs/common';
import { AuthGuard } from '@nestjs/passport';
